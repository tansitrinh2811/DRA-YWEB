...
describe("Swap Mixed Token", ()=>{
    ...
    before(async()=>{
        ...
        const MixedSwapToken = await ethers.getContractFactory("MixedSwapToken");
        mixedSwapToken = await MixedSwapToken.deploy();
    ...
    it("swapExactInput. Your test is successfull", async ()=>{
        ...
        await weth.approve(mixedSwapToken.address, amountTokenIn);
        //SWAP
        await mixedSwapToken.mixedSwapTokenExactInput(amountTokenIn);
    ...
    it("swapExactOutput. Your test is successfull", async ()=>{
        ...
        await weth.approve(mixedSwapToken.address, wethTokenamountInMax);
        //SWAP
        await mixedSwapToken.mixedSwapTokenExactOutput(daiTokenAmountOut, wethTokenamountInMax);
